...
const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!selectedRegion) {
      setError('Veuillez entrer votre région');
      return;
    }
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-smash-red hover:bg-smash-red-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-smash-red"
              >
            ...
            <div className="relative">
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">
                  ...
                  <Link
                    to="/login"
                    className="font-medium text-smash-red hover:text-smash-red-dark"
                  >
                    Se connecter
                  </Link>
                </span>
